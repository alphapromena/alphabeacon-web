...
- Name: live-proposals.spec.ts >> a fresh owner + org, with its brand set up
- Location: e2e\live-proposals.spec.ts:48:1
...
Call log:
  - waiting for getByLabel('Add a source')
...
- generic [ref=e2]:
  - generic [ref=e3]:
    - generic [ref=e6]:
      ...
      - generic [ref=e68]:
        - generic [ref=e69]: Q
        - generic [ref=e71]: QA Proposals Org 1789043986362937
        ...
        - generic [ref=e89]:
          - navigation "Settings sections" [ref=e90]:
            - tablist [ref=e91]:
              ...
              - tab "Sources & topics" [active] [selected] [ref=e95] [cursor=pointer]
