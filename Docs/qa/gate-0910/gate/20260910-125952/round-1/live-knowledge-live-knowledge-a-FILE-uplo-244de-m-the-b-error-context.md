...
- Name: live-knowledge.spec.ts >> a FILE uploads straight to storage from the browser (open-item 24)
- Location: e2e\live-knowledge.spec.ts:76:1
...
Call log:
  - waiting for getByRole('radio', { name: 'Document' })
...
- generic [ref=f1e2]:
  - generic [ref=f1e3]:
    - generic [ref=f1e6]:
      ...
      - generic [ref=f1e68]:
        - generic [ref=f1e69]: Q
        - generic [ref=f1e71]: QA Knowledge Org 1789045290560982
