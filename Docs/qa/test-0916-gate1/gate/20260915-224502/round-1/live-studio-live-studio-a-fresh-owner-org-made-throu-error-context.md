...
- Name: live-studio.spec.ts >> a fresh owner + org, made through the product
- Location: e2e\live-studio.spec.ts:37:1
...
- group:
  ...
  - textbox "Full name":
    ...
    - text: QA Studio Owner
- group:
  - text: Work email
  - textbox "Work email":
    - /placeholder: you@company.com
    - text: qa+1789513568647750s@alphapromena.com
- group:
  - text: Password
...
- group:
  ...
  - textbox "Organization name":
    ...
    - text: QA Studio Org 1789513568647750
