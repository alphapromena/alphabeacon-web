...
- Name: live-media-upload.spec.ts >> a fresh owner + org, made through the product
- Location: e2e\live-media-upload.spec.ts:48:1
...
- group:
  ...
  - textbox "Work email":
    ...
    - text: qa+1789513396974973med@alphapromena.com
- group:
  - text: Password
...
- group:
  ...
  - textbox "Organization name":
    ...
    - text: QA Media Org 1789513396974973
