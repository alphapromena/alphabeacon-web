...
- Name: live-wallet.spec.ts >> a fresh owner + org, made through the product
- Location: e2e\live-wallet.spec.ts:51:1
...
- group:
  ...
  - textbox "Full name":
    ...
    - text: QA Wallet Owner
- group:
  - text: Work email
  - textbox "Work email":
    - /placeholder: you@company.com
    - text: qa+1789513652564044w@alphapromena.com
- group:
  - text: Password
...
- group:
  ...
  - textbox "Organization name":
    ...
    - text: QA Wallet Org 1789513652564044
