...
- Name: live-knowledge.spec.ts >> a fresh owner + org, made through the product
- Location: e2e\live-knowledge.spec.ts:36:1
...
- group:
  ...
  - textbox "Full name":
    ...
    - text: QA Knowledge Owner
- group:
  - text: Work email
  - textbox "Work email":
    - /placeholder: you@company.com
    - text: qa+1789513335871824k@alphapromena.com
- group:
  - text: Password
...
- group:
  ...
  - textbox "Organization name":
    ...
    - text: QA Knowledge Org 1789513335871824
