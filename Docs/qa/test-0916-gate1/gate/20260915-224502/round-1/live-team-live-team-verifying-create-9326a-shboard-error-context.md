...
- Name: live-team.spec.ts >> verifying creates the org LIVE; the dashboard follows immediately
- Location: e2e\live-team.spec.ts:76:1
...
- group:
  ...
  - textbox "Work email":
    ...
    - text: qa+1789513599174180o@alphapromena.com
- group:
  - text: Password
...
- group:
  ...
  - textbox "Organization name":
    ...
    - text: QA Live Org 1789513599174180
