...
```
Error: photoshoot.generate · five referenceImages: {"error":{"code":"bad_request","message":"The media service rejected the request — check the body against the capability's schema","requestId":"abc39336-4b76-4999-9edd-996da3dc516d"}}
...
- generic [ref=e2]:
  - generic [ref=e3]:
    - generic [ref=e6]:
      ...
      - generic [ref=e70]:
        - generic [ref=e71]: Q
        - generic [ref=e73]: QA Media Capabilities Org 1789462763448718
