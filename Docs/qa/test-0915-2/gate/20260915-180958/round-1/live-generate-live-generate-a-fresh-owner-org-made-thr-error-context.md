...
- Name: live-generate.spec.ts >> a fresh owner + org, made through the product
- Location: e2e\live-generate.spec.ts:50:1
...
- group:
  ...
  - textbox "Full name":
    ...
    - text: QA Generate Owner
- group:
  - text: Work email
  - textbox "Work email":
    - /placeholder: you@company.com
    - text: qa+1789497009943344g@alphapromena.com
- group:
  - text: Password
...
- group:
  ...
  - textbox "Organization name":
    ...
    - text: QA Generate Org 1789497009943344
