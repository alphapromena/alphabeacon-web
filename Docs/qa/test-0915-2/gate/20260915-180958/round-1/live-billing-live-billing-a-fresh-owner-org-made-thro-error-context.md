...
- Name: live-billing.spec.ts >> a fresh owner + org, made through the product
- Location: e2e\live-billing.spec.ts:62:1
...
- group:
  ...
  - textbox "Full name":
    ...
    - text: QA Billing Owner
- group:
  - text: Work email
  - textbox "Work email":
    - /placeholder: you@company.com
    - text: qa+1789496963838671bl@alphapromena.com
- group:
  - text: Password
...
- group:
  ...
  - textbox "Organization name":
    ...
    - text: QA Billing Org 1789496963838671
