...
```
Error: photoshoot.generate · five referenceImages: {"error":{"code":"bad_request","message":"The media service rejected the request — check the body against the capability's schema","requestId":"8c8bb992-ecfb-405f-b413-2129e4257b37"}}
...
- generic [ref=e2]:
  - generic [ref=e3]:
    - generic [ref=e6]:
      ...
      - generic [ref=e70]:
        - generic [ref=e71]: Q
        - generic [ref=e73]: QA Media Capabilities Org 1789496658631810
