...
- Name: live-brand-rules.spec.ts >> a fresh owner + org, made through the product
- Location: e2e\live-brand-rules.spec.ts:72:1
...
- group:
  ...
  - textbox "Work email":
    ...
    - text: qa+1789496986339492r@alphapromena.com
- group:
  - text: Password
...
- group:
  ...
  - textbox "Organization name":
    ...
    - text: QA Rules Org 1789496986339492
