...
function printSummary(failed: boolean): void {
  ...
  console.log('     design.md now exists, written from the Alpha MENA Branding Kit, and')
  console.log('     tokens.test.ts proves the palette meets AA. What a machine cannot judge')
  console.log('     is whether it LOOKS like the brand: check the rose against the kit')
  console.log('     swatches, the Barlow setting, the wordmark, and status treatments.')
